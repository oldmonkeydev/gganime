...
public class Option2 extends scraper {
    ...
    public ArrayList<Quality> getQualityUrls()
    {
        ...
        try {
            ...
            android.util.Log.i("vidcdn","vidcdn is "+vidCdnUrl);
            ...
            if(!m3u8Link.equals(""))
            {
                ...
                android.util.Log.i("m3u8Url",m3u8Link);

                host =  url.getHost();
                android.util.Log.i("myhost",host);
                ...
                android.util.Log.i("baseIs",base);

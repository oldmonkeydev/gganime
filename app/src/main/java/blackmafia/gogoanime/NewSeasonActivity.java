...
public class NewSeasonActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        InitValues();
        contentNewSeasonActivity = new ContentNewSeasonActivity();
        contentNewSeasonActivity.execute(link);
            ...
            public void onClick(View view) {
                if(currentPage <= 1 ){
                    ...
                    if(currentPage == 2){
                        ...
                        currentPage --;
                        contentNewSeasonActivity = new ContentNewSeasonActivity();
                        contentNewSeasonActivity.execute(link + "?page="+currentPage);
    ...
    private class ContentNewSeasonActivity extends AsyncTask<String, Void, Void> {
